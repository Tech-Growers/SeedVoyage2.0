...
namespace SeedVoyageApp.Controllers
{
    public class ProduceController : Controller
    {
        ...
        public ProduceController(SeedVoyageContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("GrowerEmail,ProduceId,ProduceName,ProduceImage,Price,Quantity")] Produce produce)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("GrowerEmail,ProduceId,ProduceName,ProduceImage,Price,Quantity")] Produce produce)
        {
